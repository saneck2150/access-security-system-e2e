...
T2 & \texttt{ProtocolAnomalyDetector} (profily R2) zablokoval všetky testované útoky (0\% úspešnosť v S1--S5). V scenároch S3 a S4 bol jediným z testovaných mechanizmov, ktorý útok zastavil. \\
