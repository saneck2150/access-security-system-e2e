...
//! @param c [in] Hex character ('0'-'9', 'a'-'f', 'A'-'F').
//! @return Value 0-15.
...
//! @param hex [in] Hex string (whitespace is ignored, must contain 2*N hex
//! chars).
//! @return Parsed byte array.
//! @throws std::invalid_argument if hex length is wrong or contains invalid
//! chars.
template <size_t N>
