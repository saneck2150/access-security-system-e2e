...
\begin{itemize}
\item zdrojový kód projektu vrátane produkčného serverového kódu, firmvéru ESP32, experimentálneho harnessu, analytického pipeline a~konfiguračných súborov;
